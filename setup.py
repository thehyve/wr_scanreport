...
def get_version():
    main_file = os.path.join(CURDIR, "wr_scanreport", "main.py")
...
setup(
    ...
    version=get_version(),
    author="Maxim Moinat",
    author_email="maxim@thehyve.nl",
    description="",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/thehyve/wr_scanreport",
    packages=find_packages(exclude=EXCLUDE_FROM_PACKAGES),
    include_package_data=True,
    keywords=[],
    scripts=[],
    # entry_points={"console_scripts": ["wr_scanreport=wr_scanreport.main:main"]},
    zip_safe=False,
